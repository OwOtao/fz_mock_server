...
function BuffEffect121:create()
    return BuffEffect121.new():__init()
end

function BuffEffect121:__init()
    self.__isInit = false
...
function BuffEffect121:updateEffectValue()
...
function BuffEffect121:makeEffectOnAdd()
    ...
    FightUtil:printFormatLog("BuffEffect121:makeEffectOnAdd %s 角色属性修正效果添加触发，属性ID=%s，修正值=%s", self.__buff:getBuffOwner():getAttr("name"), self.__attrName, self.__addValue)
    
    self.__buff:getBuffOwner():addBuffAddAttr(self.__attrName, self.__addValue)
end

function BuffEffect121:makeEffectOnRemove()
    FightUtil:printFormatLog("BuffEffect121:makeEffectOnRemove %s 角色属性修正效果移除触发，属性ID=%s，修正值=%s", self.__buff:getBuffOwner():getAttr("name"), self.__attrName, -self.__addValue)
...
function BuffEffect121:makeEffectOnTransfer(buffEffect)
end

return newClass("BuffEffect121", {ABuffEffect}, BuffEffect121)
000000000000