...
local AdderCondition12 = {
    __type = ADDER_CONDITION_TYPE.NO_HAS_WEAPON_FIRST_TYPE
}

function AdderCondition12:create(conditonTarget, conditionResultType, conditionParams)
    return AdderCondition12.new():__init(conditonTarget, conditionResultType, conditionParams)
end

function AdderCondition12:__init(conditonTarget, conditionResultType, conditionParams)
...
function AdderCondition12:__checkOneTargetConditions(target, weaponFirstTypeArray)
    local results = {}
...
function AdderCondition12:matchCondititon()
    ...
    error("AdderCondition12:matchCondititon 未知判断类型：" .. tostring(self.__conditionResultType))
end

return newClass("AdderCondition12", {AAdderCondition}, AdderCondition12)
00000