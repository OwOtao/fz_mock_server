...
local ActiveBuffAdderGroup = {}

function ActiveBuffAdderGroup:create()
    return ActiveBuffAdderGroup.new()
end

function ActiveBuffAdderGroup:__initBuffAdder(buffLauncherId)
    local adderClasses = BuffConf:getActiveBuffAdderGroupResClass(buffLauncherId)
...
return newClass("ActiveBuffAdderGroup", {AFightCharacterBuffAdderGroup}, ActiveBuffAdderGroup)
0