...
local AttackerPopTextByHitArrayBuilder = {}

function AttackerPopTextByHitArrayBuilder:create()
    return AttackerPopTextByHitArrayBuilder.new()
end
...
function PopTextByHitArrayBuilder:__initEffectAttrsByQiDamagePopText()
    ...
    if #self.__effectAttrsByQiDamageArray > 0 then
        for i = 1, #self.__effectAttrsByQiDamageArray do
            ...
            local popPrefix = effect:getActiveEffectAtkRolePop()
...
return newClass("AttackerPopTextByHitArrayBuilder",{PopTextByHitArrayBuilder},AttackerPopTextByHitArrayBuilder)0