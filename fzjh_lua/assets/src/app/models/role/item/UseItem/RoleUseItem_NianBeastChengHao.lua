...
local RoleUseItem_NianBeastChengHao = {}

function RoleUseItem_NianBeastChengHao:__doUseItem()
        ...
        function(status, errcode, errmsg, data)
            if status == 200 and errcode == 0 then
                if data and tonumber(data.numbers) > 0 then                  
                    local basicTitleId = RoleTitleConst.SpecialBasicTitleId.TigerTitle
...
return NewClass("RoleUseItem_NianBeastChengHao", {AbstractUseItem}, RoleUseItem_NianBeastChengHao)
00000000000000