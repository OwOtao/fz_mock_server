...
local RoleUseItem_AnniversaryTitleOf6th = {}

function RoleUseItem_AnniversaryTitleOf6th:__doUseItem()
        ...
        function(status, errcode, errmsg, data)
            if status == 200 and errcode == 0 then
                if data and tonumber(data.numbers) > 0 then
                    local basicTitleId = RoleTitleConst.SpecialBasicTitleId.Anniversary6
...
return NewClass("RoleUseItem_AnniversaryTitleOf6th", {AbstractUseItem}, RoleUseItem_AnniversaryTitleOf6th)
00