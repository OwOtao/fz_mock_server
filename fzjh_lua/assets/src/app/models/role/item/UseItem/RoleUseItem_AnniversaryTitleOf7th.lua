...
local RoleUseItem_AnniversaryTitleOf7th = {}

function RoleUseItem_AnniversaryTitleOf7th:__doUseItem()
    local item = self._item
    local itemId = item.id
    local role = self._role

    local basicTitleId = RoleTitleConst.SpecialBasicTitleId.Anniversary7
...
return NewClass("RoleUseItem_AnniversaryTitleOf7th", {AbstractUseItem}, RoleUseItem_AnniversaryTitleOf7th)
0000