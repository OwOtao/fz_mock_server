--[[
    author:Seven
    time:2024-01-19 14:46:23
    desc: 挑战副本面板属性展示角色属性类
]]
...
local ChallengeMapCharacterAttr = {}

function ChallengeMapCharacterAttr:create()
    return ChallengeMapCharacterAttr.new()
end

--@desc: 角色攻击力
function ChallengeMapCharacterAttr:__getAtk()
    -- * 角色等级：角色当前等级
    ...
    -- * 常态Buff比例加成
    local normalBuffPercentAddition = self.__character:getBuffMulAttr("atk")

    -- * 常态Buff固值加成
    local normalBuffConstAddition = self.__character:getBuffAddAttr("atk")
    ...
    FightUtil:printLog("ChallengeMapCharacterAttr Attr GetAtk 攻击力: ", self:getAttr("name"))
...
--@desc: 防御力
function ChallengeMapCharacterAttr:__getDef()
    --* 角色等级
    local c_lv = self:getAttr("lv")
    ...
    -- * 常态Buff比例加成
    local normalBuffPercentAddition = self.__character:getBuffMulAttr("def")

    -- * 常态Buff固值加成
    local normalBuffConstAddition = self.__character:getBuffAddAttr("def")
    ...
    FightUtil:printLog("ChallengeMapCharacterAttr Attr GetDef 防御力: ", self:getAttr("name"))
    FightUtil:printLog("│├ parmas 角色等级 ：", c_lv)
...
--@desc: 防护力
function ChallengeMapCharacterAttr:__getProtect()
    ...
    -- * 常态Buff比例加成
    local normalBuffPercentAddition = self.__character:getBuffMulAttr("protect")

    -- * 常态Buff固值加成
    local normalBuffConstAddition = self.__character:getBuffAddAttr("protect")
    ...
    FightUtil:printLog("ChallengeMapCharacterAttr Attr getProtect 防护力: ", self:getAttr("name"))
...
function ChallengeMapCharacterAttr:__getDodgeForce()
    local c_lv = self:getAttr("lv")
    ...
    -- * 常态Buff比例加成
    local normalBuffPercentAddition = self.__character:getBuffMulAttr("dodgeForce")

    -- * 常态Buff固值加成
    local normalBuffConstAddition = self.__character:getBuffAddAttr("dodgeForce")
    ...
    FightUtil:printLog("ChallengeMapCharacterAttr Attr getDodgeForce 闪躲力: ", self:getAttr("name"))
    FightUtil:printLog("│├ parmas 角色等级 ：", c_lv)
...
function ChallengeMapCharacterAttr:__getParryForce()
    ...
    -- * 常态Buff比例加成
    local normalBuffPercentAddition = self.__character:getBuffMulAttr("parryForce")

    -- * 常态Buff固值加成
    local normalBuffConstAddition = self.__character:getBuffAddAttr("parryForce")
    ...
    FightUtil:printLog("ChallengeMapCharacterAttr Attr getParryForce 招架力: ", self:getAttr("name"))
...
function ChallengeMapCharacterAttr:__getDamage()
    -- * 实际加力值：玩家在加力界面实际加点的值
    local plusPoint = self:getAttr("plusPoint")

    FightUtil:printLog("ChallengeMapCharacterAttr Attr __getDamage 伤害力: ", self:getAttr("name"))
    ...
    -- * 常态Buff比例加成
    local normalBuffPercentAddition = self.__character:getBuffMulAttr("damage")

    -- * 常态Buff固值加成
    local normalBuffConstAddition = self.__character:getBuffAddAttr("damage")
...
return newClass("ChallengeMapCharacterAttr", {PlayerAttr}, ChallengeMapCharacterAttr)
000000000000