...
local TASK_ID = "task20"
local jiNanRes = LiLianTaskHelper:getTaskConfigInfo(TASK_ID)
...
task.desc = string.split(jiNanRes["text"], ";")
task.texttime =  string.split(jiNanRes["texttime"], ";") 
