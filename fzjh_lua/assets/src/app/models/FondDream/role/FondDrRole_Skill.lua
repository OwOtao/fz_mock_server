local FondDrRole_Skill = clone(require("app.models.role.Role_Skill"))

function FondDrRole_Skill:prepareSkill(type, skillName)
    if skillName == "" then
        return false
    end
...
function FondDrRole_Skill:getSkillLvLimit(skillId)
	return 1200
end

return FondDrRole_Skill
000000