...
local ZhenGaoXuanJingSkillInfoPresenter = {}

function ZhenGaoXuanJingSkillInfoPresenter:create()
    local p = ZhenGaoXuanJingSkillInfoPresenter:new()
    p:init()
    return p
end

function ZhenGaoXuanJingSkillInfoPresenter:init()
    self.__costJing = 30
end

function ZhenGaoXuanJingSkillInfoPresenter:showLayer()
    ...
    local func2 = function()
        ...
        local isOk ,msg = self:__canYingGuanPoXu()
...
function ZhenGaoXuanJingSkillInfoPresenter:__showSkilInfo()
    local name = self.__skill:getName()
...
function ZhenGaoXuanJingSkillInfoPresenter:__canYingGuanPoXu()
...
function ZhenGaoXuanJingSkillInfoPresenter:__yingGuanPoXu()
    local costPot = self:__getCostPot()
...
function ZhenGaoXuanJingSkillInfoPresenter:__getCostPot()
...
return class("ZhenGaoXuanJingSkillInfoPresenter", {BaseSkillInfoPopPresenter}, ZhenGaoXuanJingSkillInfoPresenter)
0000000000000000