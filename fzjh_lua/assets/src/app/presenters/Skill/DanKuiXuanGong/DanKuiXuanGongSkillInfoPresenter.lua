...
local DanKuiXuanGongSkillInfoPresenter = {}

function DanKuiXuanGongSkillInfoPresenter:create()
    local p = DanKuiXuanGongSkillInfoPresenter:new()
    p:init()
    return p
end

function DanKuiXuanGongSkillInfoPresenter:init()
    self.__costJing = 30
end

function DanKuiXuanGongSkillInfoPresenter:showLayer()
    ...
    local func2 = function()
        ...
        local isOk ,msg = self:__canZhaiXin()
...
function DanKuiXuanGongSkillInfoPresenter:__showSkilInfo()
    local name = self.__skill:getName()
...
function DanKuiXuanGongSkillInfoPresenter:__zhaiXin()
    local costPot = self:__getCostPot()
...
function DanKuiXuanGongSkillInfoPresenter:__getCostPot()
    local totalInt = self.__role:getFinalAttr("currInt")
	
    local costPot = Helper:mathFloor(50 * (200 + totalInt) * 0.5)

    return math.max(1,costPot)
end


return class("DanKuiXuanGongSkillInfoPresenter", {BaseSkillInfoPopPresenter}, DanKuiXuanGongSkillInfoPresenter)
000