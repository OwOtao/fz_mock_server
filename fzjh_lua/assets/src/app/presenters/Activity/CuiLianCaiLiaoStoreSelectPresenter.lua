local CuiLianCaiLiaoStoreSelectPresenter = class("CuiLianCaiLiaoStoreSelectPresenter", cc.Layer)

function CuiLianCaiLiaoStoreSelectPresenter:create()
    local p = CuiLianCaiLiaoStoreSelectPresenter:new()
    p:init()
    return p
end

function CuiLianCaiLiaoStoreSelectPresenter:init()
...
function CuiLianCaiLiaoStoreSelectPresenter:showLayer()
    self._ui:showUI()
    self:__initSelectButton()
end

function CuiLianCaiLiaoStoreSelectPresenter:hideLayer()
    PopupLayerController:hideLayer("CuiLianCaiLiaoStoreSelectPresenter",function()
        self._ui:hideUI()
    end)
end

function CuiLianCaiLiaoStoreSelectPresenter:setBuyNumber(num)
    self.__buyNumber = num
end

function CuiLianCaiLiaoStoreSelectPresenter:setMaxBuyNumber(num)
    self.__maxBuyNumber = num
end

function CuiLianCaiLiaoStoreSelectPresenter:setUnitPrice(price)
    self.__unitPrice = price
end

function CuiLianCaiLiaoStoreSelectPresenter:setPriceName(name)
    self.__priceName = name
end

function CuiLianCaiLiaoStoreSelectPresenter:setItemName(name)
    self.__itemName = name
end

function CuiLianCaiLiaoStoreSelectPresenter:setTitle(title)
    self._ui:setTitleText(title)
end

function CuiLianCaiLiaoStoreSelectPresenter:setTextDesc_1(str)
    self._ui:setTextDescStr("Text_desc_1", str)
end

function CuiLianCaiLiaoStoreSelectPresenter:setTextDesc_2(str)
    self._ui:setTextDescStr("Text_desc_2", str)
end

function CuiLianCaiLiaoStoreSelectPresenter:setTextDesc_3(str1, str2)
    local str = self:__getReturnString(str1, str2)
    self._ui:setTextDescStr("Text_desc_3", str)
end

function CuiLianCaiLiaoStoreSelectPresenter:setText_1Str(str)
    self._ui:setTextStr("Text_1", str)
end

function CuiLianCaiLiaoStoreSelectPresenter:setText_2Str(str)
    self._ui:setTextStr("Text_2", str)
end

function CuiLianCaiLiaoStoreSelectPresenter:setSelectText(str)
    self._ui:setSelectTextStr(str)
end

function CuiLianCaiLiaoStoreSelectPresenter:setButton_1Func(func)
    local func = function()
...
function CuiLianCaiLiaoStoreSelectPresenter:setButton_2Func(func)
    self._ui:setButton_2Func(func)
end

function CuiLianCaiLiaoStoreSelectPresenter:__initSelectButton()
    self.__touchTime = 0
...
function CuiLianCaiLiaoStoreSelectPresenter:__updateSelectBtnUI()
...
function CuiLianCaiLiaoStoreSelectPresenter:__refreshUI()
    self:__updateSelectBtnUI()
    self:setSelectText(tostring(self.__buyNumber).."/"..tostring(self.__maxBuyNumber))
    self:setTextDesc_3(self.__itemName, self.__buyNumber * self.__unitPrice)
end

function CuiLianCaiLiaoStoreSelectPresenter:__getReturnString(desc1, desc2)
	local str = ""
...
function CuiLianCaiLiaoStoreSelectPresenter:__setSelectLeft_1Func()
...
function CuiLianCaiLiaoStoreSelectPresenter:__setSelectLeft_2Func()
    local func1 = self:__update(function()
...
function CuiLianCaiLiaoStoreSelectPresenter:__setSelectRight_1Func()
    local func1 = self:__update(function()
        if self.__maxBuyNumber - self.__buyNumber >= 1 then
            self.__buyNumber = self.__buyNumber + 1
            self:__refreshUI()
...
function CuiLianCaiLiaoStoreSelectPresenter:__setSelectRight_2Func()
    local func1 = self:__update(function()
        if self.__maxBuyNumber - self.__buyNumber >= 10 then
            self.__buyNumber = self.__buyNumber + 10
            self:__refreshUI()
...
function CuiLianCaiLiaoStoreSelectPresenter:__update(callback)
...
function CuiLianCaiLiaoStoreSelectPresenter:__stopSchedule()
...
function CuiLianCaiLiaoStoreSelectPresenter:__setSelectLeft_1Enable(enable)
    self._ui:setSelectButtonEnable("Button_left_1", enable)
end

function CuiLianCaiLiaoStoreSelectPresenter:__setSelectLeft_2Enable(enable)
    self._ui:setSelectButtonEnable("Button_left_2", enable)
end

function CuiLianCaiLiaoStoreSelectPresenter:__setSelectRight_1Enable(enable)
    self._ui:setSelectButtonEnable("Button_right_1", enable)
end

function CuiLianCaiLiaoStoreSelectPresenter:__setSelectRight_2Enable(enable)
    self._ui:setSelectButtonEnable("Button_right_2", enable)
end

function CuiLianCaiLiaoStoreSelectPresenter:__setSelectLeft_1Texture(texture)
    self._ui:setSelectButtonTexture("Button_left_1", texture)
end

function CuiLianCaiLiaoStoreSelectPresenter:__setSelectLeft_2Texture(texture)
    self._ui:setSelectButtonTexture("Button_left_2", texture)
end

function CuiLianCaiLiaoStoreSelectPresenter:__setSelectRight_1Texture(texture)
    self._ui:setSelectButtonTexture("Button_right_1", texture)
end

function CuiLianCaiLiaoStoreSelectPresenter:__setSelectRight_2Texture(texture)
    self._ui:setSelectButtonTexture("Button_right_2", texture)
end

Helper:classDefNodeGetInstance(CuiLianCaiLiaoStoreSelectPresenter)

return CuiLianCaiLiaoStoreSelectPresenter
00000000000000