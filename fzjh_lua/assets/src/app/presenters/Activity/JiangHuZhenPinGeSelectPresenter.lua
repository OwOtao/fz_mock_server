local JiangHuZhenPinGeSelectPresenter = class("JiangHuZhenPinGeSelectPresenter", cc.Layer)

function JiangHuZhenPinGeSelectPresenter:create()
    local p = JiangHuZhenPinGeSelectPresenter:new()
    p:init()
    return p
end

function JiangHuZhenPinGeSelectPresenter:init()
    ...
    self.__unitGetNumber = 1
end

function JiangHuZhenPinGeSelectPresenter:showLayer()
    self._ui:showUI()
    self:__initSelectButton()
end

function JiangHuZhenPinGeSelectPresenter:hideLayer()
    PopupLayerController:hideLayer("JiangHuZhenPinGeSelectPresenter",function()
        self._ui:hideUI()
    end)
end

function JiangHuZhenPinGeSelectPresenter:setBuyNumber(num)
    self.__buyNumber = num
end

function JiangHuZhenPinGeSelectPresenter:setMaxBuyNumber(num)
    self.__maxBuyNumber = num
end

function JiangHuZhenPinGeSelectPresenter:setUnitGetNumber(num)
    self.__unitGetNumber = num
end

function JiangHuZhenPinGeSelectPresenter:setUnitPrice(price)
    self.__unitPrice = price
end

function JiangHuZhenPinGeSelectPresenter:setPriceName(name)
    self.__priceName = name
end

function JiangHuZhenPinGeSelectPresenter:setItemName(name)
    self.__itemName = name
end

function JiangHuZhenPinGeSelectPresenter:setTitle(title)
    self._ui:setTitleText(title)
end

function JiangHuZhenPinGeSelectPresenter:setTextDesc_1(str)
    self._ui:setTextDescStr("Text_desc_1", str)
end

function JiangHuZhenPinGeSelectPresenter:setTextDesc_2(str)
    self._ui:setTextDescStr("Text_desc_2", str)
end

function JiangHuZhenPinGeSelectPresenter:setTextDesc_3(str1, str2)
    local str = self:__getReturnString(str1, str2)
    self._ui:setTextDescStr("Text_desc_3", str)
end

function JiangHuZhenPinGeSelectPresenter:setText_1Str(str)
    self._ui:setTextStr("Text_1", str)
end

function JiangHuZhenPinGeSelectPresenter:setText_2Str(str)
    self._ui:setTextStr("Text_2", str)
end

function JiangHuZhenPinGeSelectPresenter:setSelectText(str)
    self._ui:setSelectTextStr(str)
end

function JiangHuZhenPinGeSelectPresenter:setButton_1Func(func)
    local func = function()
...
function JiangHuZhenPinGeSelectPresenter:setButton_2Func(func)
    self._ui:setButton_2Func(func)
end

function JiangHuZhenPinGeSelectPresenter:__initSelectButton()
    self.__touchTime = 0
...
function JiangHuZhenPinGeSelectPresenter:__updateSelectBtnUI()
...
function JiangHuZhenPinGeSelectPresenter:__refreshUI()
    self:__updateSelectBtnUI()
    ...
    self:setTextDesc_3(self.__itemName, self.__buyNumber * self.__unitGetNumber)
end

function JiangHuZhenPinGeSelectPresenter:__getReturnString(desc1, desc2)
	local str = ""
...
function JiangHuZhenPinGeSelectPresenter:__setSelectLeft_1Func()
...
function JiangHuZhenPinGeSelectPresenter:__setSelectLeft_2Func()
    local func1 = self:__update(function()
...
function JiangHuZhenPinGeSelectPresenter:__setSelectRight_1Func()
    local func1 = self:__update(function()
        if self.__maxBuyNumber - self.__buyNumber >= 1 then
            self.__buyNumber = self.__buyNumber + 1
            self:__refreshUI()
...
function JiangHuZhenPinGeSelectPresenter:__setSelectRight_2Func()
    local func1 = self:__update(function()
        if self.__maxBuyNumber - self.__buyNumber >= 10 then
            self.__buyNumber = self.__buyNumber + 10
            self:__refreshUI()
...
function JiangHuZhenPinGeSelectPresenter:__update(callback)
...
function JiangHuZhenPinGeSelectPresenter:__stopSchedule()
...
function JiangHuZhenPinGeSelectPresenter:__setSelectLeft_1Enable(enable)
    self._ui:setSelectButtonEnable("Button_left_1", enable)
end

function JiangHuZhenPinGeSelectPresenter:__setSelectLeft_2Enable(enable)
    self._ui:setSelectButtonEnable("Button_left_2", enable)
end

function JiangHuZhenPinGeSelectPresenter:__setSelectRight_1Enable(enable)
    self._ui:setSelectButtonEnable("Button_right_1", enable)
end

function JiangHuZhenPinGeSelectPresenter:__setSelectRight_2Enable(enable)
    self._ui:setSelectButtonEnable("Button_right_2", enable)
end

function JiangHuZhenPinGeSelectPresenter:__setSelectLeft_1Texture(texture)
    self._ui:setSelectButtonTexture("Button_left_1", texture)
end

function JiangHuZhenPinGeSelectPresenter:__setSelectLeft_2Texture(texture)
    self._ui:setSelectButtonTexture("Button_left_2", texture)
end

function JiangHuZhenPinGeSelectPresenter:__setSelectRight_1Texture(texture)
    self._ui:setSelectButtonTexture("Button_right_1", texture)
end

function JiangHuZhenPinGeSelectPresenter:__setSelectRight_2Texture(texture)
    self._ui:setSelectButtonTexture("Button_right_2", texture)
end

Helper:classDefNodeGetInstance(JiangHuZhenPinGeSelectPresenter)

return JiangHuZhenPinGeSelectPresenter
000000000