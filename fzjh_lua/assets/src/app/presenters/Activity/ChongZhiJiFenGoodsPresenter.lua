local ChongZhiJiFenGoodsPresenter = class("ChongZhiJiFenGoodsPresenter", cc.Layer)

function ChongZhiJiFenGoodsPresenter:create()
    local p = ChongZhiJiFenGoodsPresenter:new()
    p:init()
    return p
end

function ChongZhiJiFenGoodsPresenter:init()
...
function ChongZhiJiFenGoodsPresenter:showLayer()
    self._ui:showUI()
    self:__initSelectButton()
end

function ChongZhiJiFenGoodsPresenter:hideLayer()
    PopupLayerController:hideLayer("ChongZhiJiFenGoodsPresenter",function()
        self._ui:hideUI()
    end)
end

function ChongZhiJiFenGoodsPresenter:setBuyNumber(num)
    self.__buyNumber = num
end

function ChongZhiJiFenGoodsPresenter:setMaxBuyNumber(num)
    self.__maxBuyNumber = num
end

function ChongZhiJiFenGoodsPresenter:setUnitPrice(price)
    self.__unitPrice = price
end

function ChongZhiJiFenGoodsPresenter:setPriceName(name)
    self.__priceName = name
end

function ChongZhiJiFenGoodsPresenter:setItemName(name)
    self.__itemName = name
end

function ChongZhiJiFenGoodsPresenter:setTitle(title)
    self._ui:setTitleText(title)
end

function ChongZhiJiFenGoodsPresenter:setTextDesc_1(str)
    self._ui:setTextDescStr("Text_desc_1", str)
end

function ChongZhiJiFenGoodsPresenter:setTextDesc_2(str)
    self._ui:setTextDescStr("Text_desc_2", str)
end

function ChongZhiJiFenGoodsPresenter:setTextDesc_3(str1, str2)
    local str = self:__getReturnString(str1, str2)
    self._ui:setTextDescStr("Text_desc_3", str)
end

function ChongZhiJiFenGoodsPresenter:setTextDesc_4Visible(visible)
    self._ui:setTextVisible("Text_desc_4", visible)
end

function ChongZhiJiFenGoodsPresenter:setTextDesc_4Func(func)
...
function ChongZhiJiFenGoodsPresenter:setText_1Str(str)
    self._ui:setTextStr("Text_1", str)
end

function ChongZhiJiFenGoodsPresenter:setText_2Str(str)
    self._ui:setTextStr("Text_2", str)
end

function ChongZhiJiFenGoodsPresenter:setSelectText(str)
    self._ui:setSelectTextStr(str)
end

function ChongZhiJiFenGoodsPresenter:setButton_1Func(func)
    local func = function()
...
function ChongZhiJiFenGoodsPresenter:setButton_2Func(func)
    self._ui:setButton_2Func(func)
end

function ChongZhiJiFenGoodsPresenter:__initSelectButton()
    self.__touchTime = 0
...
function ChongZhiJiFenGoodsPresenter:__updateSelectBtnUI()
...
function ChongZhiJiFenGoodsPresenter:__refreshUI()
    self:__updateSelectBtnUI()
...
function ChongZhiJiFenGoodsPresenter:__getReturnString(desc1, desc2)
	local str = ""
...
function ChongZhiJiFenGoodsPresenter:__setSelectLeft_1Func()
...
function ChongZhiJiFenGoodsPresenter:__setSelectLeft_2Func()
    local func1 = self:__update(function()
...
function ChongZhiJiFenGoodsPresenter:__setSelectRight_1Func()
    local func1 = self:__update(function()
        if self.__maxBuyNumber - self.__buyNumber >= 1 then
            self.__buyNumber = self.__buyNumber + 1
            self:__refreshUI()
...
function ChongZhiJiFenGoodsPresenter:__setSelectRight_2Func()
    local func1 = self:__update(function()
        if self.__maxBuyNumber - self.__buyNumber >= 10 then
            self.__buyNumber = self.__buyNumber + 10
            self:__refreshUI()
...
function ChongZhiJiFenGoodsPresenter:__update(callback)
...
function ChongZhiJiFenGoodsPresenter:__stopSchedule()
...
function ChongZhiJiFenGoodsPresenter:__setSelectLeft_1Enable(enable)
    self._ui:setSelectButtonEnable("Button_left_1", enable)
end

function ChongZhiJiFenGoodsPresenter:__setSelectLeft_2Enable(enable)
    self._ui:setSelectButtonEnable("Button_left_2", enable)
end

function ChongZhiJiFenGoodsPresenter:__setSelectRight_1Enable(enable)
    self._ui:setSelectButtonEnable("Button_right_1", enable)
end

function ChongZhiJiFenGoodsPresenter:__setSelectRight_2Enable(enable)
    self._ui:setSelectButtonEnable("Button_right_2", enable)
end

function ChongZhiJiFenGoodsPresenter:__setSelectLeft_1Texture(texture)
    self._ui:setSelectButtonTexture("Button_left_1", texture)
end

function ChongZhiJiFenGoodsPresenter:__setSelectLeft_2Texture(texture)
    self._ui:setSelectButtonTexture("Button_left_2", texture)
end

function ChongZhiJiFenGoodsPresenter:__setSelectRight_1Texture(texture)
    self._ui:setSelectButtonTexture("Button_right_1", texture)
end

function ChongZhiJiFenGoodsPresenter:__setSelectRight_2Texture(texture)
    self._ui:setSelectButtonTexture("Button_right_2", texture)
end

Helper:classDefNodeGetInstance(ChongZhiJiFenGoodsPresenter)

return ChongZhiJiFenGoodsPresenter
00000