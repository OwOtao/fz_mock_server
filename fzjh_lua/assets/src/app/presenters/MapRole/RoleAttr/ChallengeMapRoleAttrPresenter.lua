...
function ChallengeMapRoleAttrPresenter:showPresenter()
    PopupLayerController:showLayer("ChallengeMapRoleAttrUI",function(ui)
		self:setOutput(ui)

        for i = 1,14 do
            self.__output:setRoleAttrTextVisible(i,false)
        end

        self:__showRoleAttrPanel()
        
		self.__output:showUI()
	end)
end

function ChallengeMapRoleAttrPresenter:hidePresenter()
    PopupLayerController:hideLayer("ChallengeMapRoleAttrUI",function(ui)
		ui:hideUI()
	end)
end
...
function ChallengeMapRoleAttrPresenter:__showRoleAttrPanel()
