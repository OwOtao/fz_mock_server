...
function LayerEx:lazyInit()
    ...
    if self._showAndHideAnimDuration == nil then
        self._showAndHideAnimDuration = 0.2
    end
end
...
-- 设置动画时间
function LayerEx:setshowAndHideAnimDuration(showAndHideAnimDuration)
    if showAndHideAnimDuration == nil then
        showAndHideAnimDuration = 0.2
    end
    self._showAndHideAnimDuration = showAndHideAnimDuration
end
...
function LayerEx:showTouchSwallowLayer()
    ...
    self._touchSwallowLayer:releaseFunc(function (  )
...
function LayerEx:showWithFade(endFunc)
    ...
    self:setOpacity(0)  -- add by XiaoZhiWei 2017/02/16 18:22:02  渐现之前必须先设置透明度为0
