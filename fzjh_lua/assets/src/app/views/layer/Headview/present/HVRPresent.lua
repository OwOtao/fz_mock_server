...
function HVRPresent:_getPathByType(maskAttr,pathType)
...
function HVRPresent:_checkRoleIsPolymorphByParam(polymorph)
...
return newClass("HVRPresent", {}, HVRPresent)000