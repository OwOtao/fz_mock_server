...
function binding.unbindtwoway(table_a, key_a, table_b, key_b, tag_a2b, tag_b2a)
    binding.unbind(table_a, key_a, tag_a2b)
    binding.unbind(table_b, key_b, tag_b2a)
end


return binding00000000000