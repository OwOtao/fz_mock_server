local SignInGiftBagLayer = class("SignInGiftBagLayer", LayerEx)
function SignInGiftBagLayer:create()
	local p = SignInGiftBagLayer:new()
	p:init()
	return p
end
-----------------------------------------------------------------------------------------------------------
...
-- @desc 首充页面测试方法
function SignInGiftBagLayer:showLayer(actionId)
	local layer = self:getInstance()
	layer:show()
	layer:initLayer(actionId)
end

function SignInGiftBagLayer:init()
	local UI = require("Layer/ActionUI/SignInGiftBagUI.lua").create()['root']
	UI:addTo(self)

	Helper:convertUIByParent(self)
end
function SignInGiftBagLayer:initLayer(actionId)
	self:setButtonBack()
	self:setActionTime(actionId)
end
function SignInGiftBagLayer:setActionTime(actionId)--设置活动时间
...
function SignInGiftBagLayer:initEditBox(activityId)
...
function SignInGiftBagLayer:createEditBox()
...
function SignInGiftBagLayer:setButtonPaste(editBox)
...
function SignInGiftBagLayer:setButtonConvert(editBox,activityId)
...
function SignInGiftBagLayer:setButtonBack()
	-- self.Panel_back_0:releaseFunc(function()
		
	-- end)
end
function SignInGiftBagLayer:setChannelTagVisible(actionId,activityId,title)
	...
	local str_4399_dingzhi = "                  4399独家定制的礼包上线啦！\n    小伙伴们，在此页面输入兑换码可获得RED丰厚的奖励NOR哦！"
	local str_4399_kaixue = "                    4399独家开学礼包上线啦！\n    小伙伴们，在此页面输入兑换码可获得RED丰厚的奖励NOR哦！"
	local str_4399_jiaoshijie = "                    4399独家教师节礼包上线啦！\n    小伙伴们，在此页面输入兑换码可获得RED丰厚的奖励NOR哦！"
	local str_4399_guoqing = "                    4399独家国庆节礼包上线啦！\n    小伙伴们，在此页面输入兑换码可获得RED丰厚的奖励NOR哦！"
	local str_4399_xinshou = "                       4399新手礼包上线啦！\n    小伙伴们，在此页面输入兑换码可获得RED丰富的奖励NOR哦！"
	if device.platform == "android" then
		if CURR_DEVICE_CHANNEL == "4399" then
			...
			elseif title == "4399独家定制礼包" then
				self.Text_2:setString("兑换码")
				for i=1,7 do
					self.Panel_image["Panel_"..tostring(i)]:setVisible(false)
				end
				self.Text_title:setString(title)
				self:printPreview(str_4399_dingzhi)
				self.Panel_image["Panel_3"]:setVisible(true)
				self.Panel_image["Panel_3"].Image_2:loadTexture("Image/UI/SignInUI/baoxiang-7.png")
				self.Panel_image["Panel_3"].Text_1:setString("独家礼包")
				self.Panel_image["Panel_3"]:setPositionX(540)
			elseif title == "4399独家开学礼包" then
				self.Text_2:setString("兑换码")
				for i=1,7 do
					self.Panel_image["Panel_"..tostring(i)]:setVisible(false)
				end
				self.Text_title:setString(title)
				self:printPreview(str_4399_kaixue)
				self.Panel_image["Panel_3"]:setVisible(true)
				self.Panel_image["Panel_3"].Image_2:loadTexture("Image/UI/SignInUI/baoxiang-5.png")
				self.Panel_image["Panel_3"].Text_1:setString("开学礼包")
				self.Panel_image["Panel_3"]:setPositionX(540)
			elseif title == "4399独家教师节礼包" then
				self.Text_2:setString("兑换码")
				for i=1,7 do
					self.Panel_image["Panel_"..tostring(i)]:setVisible(false)
				end
				self.Text_title:setString(title)
				self:printPreview(str_4399_jiaoshijie)
				self.Panel_image["Panel_3"]:setVisible(true)
				self.Panel_image["Panel_3"].Image_2:loadTexture("Image/UI/SignInUI/baoxiang-5.png")
				self.Panel_image["Panel_3"].Text_1:setString("教师节礼包")
				self.Panel_image["Panel_3"]:setPositionX(540)
			elseif title == "4399独家国庆节礼包" then
				self.Text_2:setString("兑换码")
				for i=1,7 do
					self.Panel_image["Panel_"..tostring(i)]:setVisible(false)
				end
				self.Text_title:setString(title)
				self:printPreview(str_4399_guoqing)
				self.Panel_image["Panel_3"]:setVisible(true)
				self.Panel_image["Panel_3"].Image_2:loadTexture("Image/UI/SignInUI/baoxiang-7.png")
				self.Panel_image["Panel_3"].Text_1:setString("国庆节礼包")
				self.Panel_image["Panel_3"]:setPositionX(540)
			elseif title == "4399新手礼包" then
				self.Text_2:setString("兑换码")
				for i=1,7 do
					self.Panel_image["Panel_"..tostring(i)]:setVisible(false)
				end
				self.Text_title:setString(title)
				self:printPreview(str_4399_xinshou)
				self.Panel_image["Panel_3"]:setVisible(true)
				self.Panel_image["Panel_3"].Image_2:loadTexture("Image/UI/SignInUI/baoxiang-7.png")
				self.Panel_image["Panel_3"].Text_1:setString("新手礼包")
				self.Panel_image["Panel_3"]:setPositionX(540)
			else
				self.Text_2:setString("兑换码")
				for i=1,7 do
...
function SignInGiftBagLayer:printPreview(str, verticalSpace)
...
function SignInGiftBagLayer:initRichTextPreview()
...
Helper:classDefNodeGetInstance(SignInGiftBagLayer)
return SignInGiftBagLayer
00000000