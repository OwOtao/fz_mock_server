...
function EffectLink:create(effect)
    local p = EffectLink.new()
    p:init(effect)
    return p
end

function EffectLink:checkArg1()
...
return newClass("EffectLink", {BaseCheck}, EffectLink)
0000000