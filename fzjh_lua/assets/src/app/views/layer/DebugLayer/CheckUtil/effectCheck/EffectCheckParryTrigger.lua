...
function ParryTrigger:create(effect)
    local p = ParryTrigger.new()
    p:init(effect)
    return p
end

function ParryTrigger:checkArg1()
...
function ParryTrigger:checkArg2()
...
function ParryTrigger:checkArg3()
...
return newClass("ParryTrigger", {BaseCheck}, ParryTrigger)
0000000000000