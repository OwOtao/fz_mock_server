local ShenBingWareHouseUI = class("ShenBingWareHouseUI", LayerEx)

function ShenBingWareHouseUI:create()
	local p = ShenBingWareHouseUI:new()
	p:init()
	return p
end

function ShenBingWareHouseUI:init()
    self._UI = require("Layer/ShenBing/ShenBingWareHouseUI.lua").create()['root']
...
function ShenBingWareHouseUI:showUI()
    self:setVisible(true)
end

function ShenBingWareHouseUI:hideUI()
    self:setVisible(false)
end

function ShenBingWareHouseUI:setButtonBack(func)
...
function ShenBingWareHouseUI:setTextTitle(text)
    self.Image_title.Text_title:setString(text)
end

function ShenBingWareHouseUI:setText_2(text)
    self.Text_2:setString(text)
end

-- 物品描述显示
function ShenBingWareHouseUI:itemDescShow(anim)
...
-- 物品描述隐藏
function ShenBingWareHouseUI:itemDescHide(anim)
...
function ShenBingWareHouseUI:initItemDescPanel(itemInfo)
...
function ShenBingWareHouseUI:initItemList(list)
...
function ShenBingWareHouseUI:initTypeListView(list)
...
function ShenBingWareHouseUI:__cloneListView_1Item()
...
function ShenBingWareHouseUI:__initListView_1Item(panel,panelInfo)
...
function ShenBingWareHouseUI:__cloneListView_2Item()
    local item = self.Panel_typeItem:clone()
    Helper:convertUIByParent(item)
    return item
end

function ShenBingWareHouseUI:__initListView_2Item(item, itemInfo)
...
function ShenBingWareHouseUI:__initDescBackFunc()
